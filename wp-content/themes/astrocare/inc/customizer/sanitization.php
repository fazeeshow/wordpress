 ...
 * 
 * @package   Astrocare
 * @copyright Astrocare (c) 2024, WordPress Theme Review Team
 ...
 */
function astrocare_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function astrocare_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function astrocare_sanitize_html( $html ) {
 ...
 */
function astrocare_sanitize_image( $image, $setting ) {
 ...
 */
function astrocare_sanitize_nohtml( $nohtml ) {
 ...
 */
function astrocare_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function astrocare_sanitize_range_value( $number, $setting ) {
 ...
 */
function astrocare_sanitize_select( $input, $setting ) {
 ...
 */
function astrocare_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/* Sanitization Text*/
function astrocare_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function astrocare_sanitize_integer( $input ) {
	if( is_numeric( $input ) ) {
		return intval( $input );
	}
}